...
// ─── Category palette ────────────────────────────────────────────────────────
// A = header bg (lightest), B = icon rect + badge bg (mid),
// C = stat-num + "Oku" link + icon main color (dark), D = stat-lbl + badge text
...
// Returns SVG JSX directly — no component-in-record lookup pattern.

function renderCategoryIcon(category: string, size: number = 44) {
  switch (category) {
    case 'Hasta Büyümesi':
    case 'Hasta Deneyimi':
      return (
        <svg width={size} height={size} viewBox="0 0 44 44" fill="none" aria-hidden="true">
          ...
          <ellipse cx="22" cy="17" rx="6" ry="6" fill="#185FA5" fillOpacity="0.25"/>
          <circle cx="22" cy="16" r="5" fill="#185FA5"/>
          <path d="M10 34c0-6.627 5.373-10 12-10s12 3.373 12 10" fill="#185FA5" fillOpacity="0.4"/>
          <path d="M13 34c0-4.97 4.03-8 9-8s9 3.03 9 8" fill="#185FA5"/>
        </svg>
      );

    case 'Klinik Yönetimi':
      return (
        <svg width={size} height={size} viewBox="0 0 44 44" fill="none" aria-hidden="true">
          <rect width="44" height="44" rx="10" fill="#CECBF6"/>
          <rect x="10" y="14" width="24" height="18" rx="3" fill="#534AB7" fillOpacity="0.25"/>
          <rect x="12" y="12" width="20" height="16" rx="2.5" fill="#534AB7"/>
          <rect x="16" y="17" width="5" height="1.5" rx="0.75" fill="white"/>
          <rect x="16" y="20.5" width="12" height="1.5" rx="0.75" fill="white" fillOpacity="0.7"/>
          <rect x="16" y="24" width="8" height="1.5" rx="0.75" fill="white" fillOpacity="0.5"/>
          <rect x="19" y="28" width="6" height="6" rx="1" fill="#534AB7" fillOpacity="0.5"/>
    ...
    case 'Teknoloji':
      return (
        <svg width={size} height={size} viewBox="0 0 44 44" fill="none" aria-hidden="true">
          ...
          <rect x="14" y="14" width="16" height="16" rx="3" fill="#0F6E56" fillOpacity="0.3"/>
          <rect x="16" y="16" width="12" height="12" rx="2" fill="#0F6E56"/>
          <circle cx="22" cy="22" r="3" fill="white"/>
          <circle cx="22" cy="22" r="1.2" fill="#0F6E56"/>
          <rect x="21.2" y="10" width="1.6" height="4" rx="0.8" fill="#0F6E56" fillOpacity="0.5"/>
          <rect x="21.2" y="30" width="1.6" height="4" rx="0.8" fill="#0F6E56" fillOpacity="0.5"/>
          <rect x="10" y="21.2" width="4" height="1.6" rx="0.8" fill="#0F6E56" fillOpacity="0.5"/>
          <rect x="30" y="21.2" width="4" height="1.6" rx="0.8" fill="#0F6E56" fillOpacity="0.5"/>
        </svg>
      );
    ...
    case 'Pazar Analizi':
      return (
        <svg width={size} height={size} viewBox="0 0 44 44" fill="none" aria-hidden="true">
          ...
          <rect x="10" y="28" width="5" height="6" rx="1" fill="#BA7517" fillOpacity="0.4"/>
          <rect x="17" y="20" width="5" height="14" rx="1" fill="#BA7517" fillOpacity="0.4"/>
          <rect x="24" y="15" width="5" height="19" rx="1" fill="#BA7517" fillOpacity="0.4"/>
    ...
    case 'Türkiye Pazarı':
      return (
        <svg width={size} height={size} viewBox="0 0 44 44" fill="none" aria-hidden="true">
          ...
          <ellipse cx="22" cy="22" rx="11" ry="11" fill="#993C1D" fillOpacity="0.2"/>
          <ellipse cx="22" cy="22" rx="8" ry="11" fill="#993C1D" fillOpacity="0.2"/>
          <ellipse cx="22" cy="22" rx="11" ry="11" fill="none" stroke="#993C1D" strokeWidth="1.5"/>
          <ellipse cx="22" cy="22" rx="8" ry="11" fill="none" stroke="#993C1D" strokeWidth="1.2" strokeOpacity="0.7"/>
          <line x1="11" y1="22" x2="33" y2="22" stroke="#993C1D" strokeWidth="1.2" strokeOpacity="0.6"/>
          <line x1="13" y1="17" x2="31" y2="17" stroke="#993C1D" strokeWidth="1" strokeOpacity="0.4"/>
          <line x1="13" y1="27" x2="31" y2="27" stroke="#993C1D" strokeWidth="1" strokeOpacity="0.4"/>
          <circle cx="22" cy="22" r="2.5" fill="#993C1D"/>
        </svg>
      );

    case 'Global':
    case 'Uluslararası Pazarlama':
      return (
        <svg width={size} height={size} viewBox="0 0 44 44" fill="none" aria-hidden="true">
          <rect width="44" height="44" rx="10" fill="#C0DD97"/>
          <circle cx="22" cy="22" r="10" fill="#3B6D11" fillOpacity="0.15"/>
          ...
          <line x1="12" y1="22" x2="32" y2="22" stroke="#3B6D11" strokeWidth="1" strokeOpacity="0.5"/>
          <line x1="14" y1="17" x2="30" y2="17" stroke="#3B6D11" strokeWidth="0.8" strokeOpacity="0.35"/>
          <line x1="14" y1="27" x2="30" y2="27" stroke="#3B6D11" strokeWidth="0.8" strokeOpacity="0.35"/>
          <circle cx="17" cy="19" r="1.5" fill="#3B6D11" fillOpacity="0.6"/>
          <circle cx="27" cy="25" r="1.5" fill="#3B6D11" fillOpacity="0.6"/>
    ...
    default:
      return (
        <svg width={size} height={size} viewBox="0 0 44 44" fill="none" aria-hidden="true">
          ...
          <rect x="24" y="12" width="8" height="8" rx="2" fill="#5F5E5A" fillOpacity="0.5"/>
          <rect x="12" y="24" width="8" height="8" rx="2" fill="#5F5E5A" fillOpacity="0.5"/>
          <rect x="24" y="24" width="8" height="8" rx="2" fill="#5F5E5A" fillOpacity="0.3"/>
        </svg>
      );
  }
}
    ...
    <article className="article-card" style={{
      ...
      >
        {hasStat ? (
          <>
            <div>
              <p style={{ fontSize: '22px', fontWeight: '500', color: pal.C, margin: 0, lineHeight: 1.1 }}>
                {frontmatter.stat}
              </p>
              <p style={{ fontSize: '10px', color: pal.D, margin: '3px 0 0', lineHeight: 1.3 }}>
                {frontmatter.statLabel}
              </p>
            </div>
            {renderCategoryIcon(frontmatter.category, 44)}
          </>
        ) : (
          renderCategoryIcon(frontmatter.category, 52)
        )}
      </Link>
